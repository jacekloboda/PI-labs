...
void check_char(const char *word, int *word_len, int *shown_letters, char *ch, int *player_num, int **score, int *shown_cnt)
{
...
void restart(const char *word, int *word_len, int *player_num, int **score)
{
    word = generate_word();
...
void wheel_of_fortune(void)
{
    ...
    //restart(word, &word_len, &player_num, score);
    ...
    while(shown_cnt <= word_len)
    {
        ...
        check_char(word, &word_len, shown_letters, &ch, &player_num, score, &shown_cnt);
